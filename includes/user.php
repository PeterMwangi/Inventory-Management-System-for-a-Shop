...
//User creation for account registration and login
...
class User
{
	...
	{
		//To protect your application from sql attack you can use a prepares statements
	...
	public function userLogin($email, $password)
	{
		...
		if ($result->num_rows < 1) {
			...
			if (password_verify($password, $row["password"])) {
				...
				//Updating user last login time while loging in
...
//$user = new User();
//echo $user->createUserAccount("Joseph", "pjosh@gmail.com", "123456789", "Admin");
//echo $user->userLogin("pjosh@gmail.com", "123456789");
