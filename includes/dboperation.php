...
class dboperation
{
    ...
    {
        $pre_stmt = $this->conn->prepare("INSERT INTO `brand`(`brand_name`, `status`) VALUES (?,?)");
        $status = 1;
    ...
    public function addproducts($cid, $bid, $pro_name, $price, $stock, $date)
    {
        $pre_stmt = $this->conn->prepare("INSERT INTO `products`
